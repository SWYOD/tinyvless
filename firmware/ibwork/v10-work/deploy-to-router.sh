...
echo "=== tinyvless v10-work deploy from $BASE ==="
...
fetch "etc/tinyvless/subscription.sh"         "/etc/tinyvless/subscription.sh"
fetch "etc/tinyvless/microtun.conf"           "/etc/tinyvless/microtun.conf"
fetch "etc/tinyvless/microtun.defaults"       "/etc/tinyvless/microtun.defaults"
fetch "etc/tinyvless/microtun-apply.sh"        "/etc/tinyvless/microtun-apply.sh"
fetch "etc/tinyvless/udp_tunnel_domains.list" "/etc/tinyvless/udp_tunnel_domains.list"
fetch "etc/uci-defaults/99-tinyvless-dnsmasq" "/etc/uci-defaults/99-tinyvless-dnsmasq"
...
fetch "www/luci-static/resources/view/tinyvless/microtun.js" "/www/luci-static/resources/view/tinyvless/microtun.js"
fetch "www/cgi-bin/tv"                          "/www/cgi-bin/tv"
fetch "www/tinyvless/index.html"                "/www/tinyvless/index.html"
"$RSSH" "mkdir -p /www/tinyvless/microtun" 15
fetch "www/tinyvless/microtun/index.html"       "/www/tinyvless/microtun/index.html"
...
BIN_TAG="tinyvless-stability-v2-20260709"
...
"$RSSH" "
chmod +x /etc/tinyvless/domains.sh /etc/tinyvless/checkdomain.sh /etc/tinyvless/dns-watchdog.sh /etc/tinyvless/api.sh /etc/tinyvless/subscription.sh /etc/tinyvless/apply-route.sh /etc/tinyvless/ru_cidr_reload.sh /etc/init.d/tinyvless /etc/init.d/tinyvless-dns /etc/init.d/tvled /www/cgi-bin/tv
